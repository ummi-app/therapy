...
| --- | --- | --- |
| L-01 | queued | Repository-wide and deployed-artifact purge of CareLedger identity plus all Stripe/payment/plan/subscription code, dependencies, routes, environment names, database artifacts, copy, and network endpoints; prove scans clean. |
